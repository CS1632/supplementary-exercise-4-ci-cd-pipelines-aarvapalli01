...
public class RentACatTest {
	...
	public void testGetCatNumCats3() {
		...
		Cat ret = r.getCat(2);
                ...
                assertNotNull("r.getCat(2) returns null", ret);
                assertEquals("returned cat id not 2", 2, ret.getId());
	}
	...
	public void testCatAvailableFalseNumCats0() {
                ...
                assertFalse("r.catAvailable(2) is true", ret);
	}
	...
	public void testCatAvailableTrueNumCats3() {
		...
		boolean ret = r.catAvailable(2);
                ...
                assertTrue("catAvailable(2) not true", ret);
	}
	...
	public void testCatAvailableFalseNumCats3() {
		...
		boolean ret = r.catAvailable(2);
                ...
                assertFalse("catAvailable(2) is not false", ret);
        }
	...
	public void testCatExistsFalseNumCats0() {
                ...
                assertFalse("catExists(2) not false", ret);
	}
	...
	public void testCatExistsTrueNumCats3() {
		...
		boolean ret = r.catExists(2);
                ...
                assertTrue("catExists(2) not true", ret);
	}
	...
	public void testListCatsNumCats3() {
		...
		String ret = r.listCats();
                ...
                assertEquals("listCats() not correct", "ID 1. Jennyanydots\nID 2. Old " +
                                "Deuteronomy\nID 3. Mistoffelees\n", ret);
	}
	...
	public void testRentCatFailureNumCats0() {
                ...
                assertFalse("rentCat(2) not false", ret);
	}
	...
	public void testReturnCatFailureNumCats0() {
                ...
                assertFalse("returnCat(2) not false", ret);
	}
	...
	public void testReturnCatNumCats3() {
		...
		assertTrue("returnCat(2) not true", ret);
		Mockito.verify(c1, Mockito.times(0)).rentCat();
